...
class Edith extends Component {
    ...
    componentDidMount(){
        ...
        Axios.get("https://kelvineapp.herokuapp.com/edithapi/" + this.props.match.params.id +"/")
        .then(response =>{
        this.setState({
            id : response.data.id,
    ...
    handleSubmit = (event) => {
        ...
        axios.post('https://kelvineapp.herokuapp.com/edithapi/' + this.props.match.params.id +"/", postdata)
            .then((result) => {
